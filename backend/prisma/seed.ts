...
async function main() {
  ...
  if (!existingUser) {
    console.error('데이터베이스에 유저가 존재하지 않습니다. 먼저 유저를 생성해주세요.');
    process.exit(1);
  }
  ...
  const courseData = [
    {
      ...
      shortDescription: 'React와 TypeScript를 함께 사용하는 현대적인 웹 개발 방법을 학습합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'Next.js 13 App Router를 활용한 모던 풀스택 웹 개발을 마스터합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'Pandas, NumPy, Matplotlib을 활용한 실전 데이터 분석 기법을 학습합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'Flutter로 크로스 플랫폼 모바일 앱을 개발하는 방법을 배웁니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'Docker와 Kubernetes를 활용한 현대적인 DevOps 환경을 구축합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'Vue 3의 Composition API를 활용한 현대적인 프론트엔드 개발을 학습합니다.',
      description:
    ...
    {
      title: 'AWS 서버리스 아키텍처',
      shortDescription: 'AWS Lambda, API Gateway, DynamoDB를 활용한 서버리스 아키텍처를 구축합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'TensorFlow를 활용한 실전 머신러닝 모델 개발과 배포를 학습합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'Spring Boot를 활용한 마이크로서비스 아키텍처 설계와 구현을 학습합니다.',
      description:
    ...
    {
      title: 'Go 언어 백엔드 개발',
      shortDescription: 'Go 언어의 특징을 활용한 고성능 백엔드 시스템 개발을 마스터합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'SwiftUI를 활용한 현대적인 iOS 앱 개발 방법을 학습합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'Rust 언어의 메모리 안전성과 성능을 활용한 시스템 프로그래밍을 학습합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'Figma를 활용한 전문적인 UI/UX 디자인 프로세스를 학습합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'Ethereum과 Solidity를 활용한 스마트 컨트랙트 개발을 학습합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'MongoDB를 활용한 NoSQL 데이터베이스 설계와 최적화를 학습합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'Unity 엔진을 활용한 2D/3D 게임 개발의 모든 것을 학습합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'PostgreSQL의 고급 기능과 쿼리 최적화 기법을 마스터합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'Jenkins를 활용한 지속적 통합과 배포 파이프라인을 구축합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'GraphQL을 활용한 효율적인 API 설계와 개발을 학습합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'Electron을 활용한 크로스 플랫폼 데스크탑 애플리케이션 개발을 학습합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'Tailwind CSS를 활용한 효율적인 반응형 웹 디자인을 마스터합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'Redis를 활용한 효과적인 캐싱 전략과 성능 최적화를 학습합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'SvelteKit을 활용한 고성능 웹 애플리케이션 개발을 학습합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: '사이버 보안의 기초부터 윤리적 해킹 기법까지 종합적으로 학습합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'Firebase를 활용한 실시간 웹 애플리케이션 개발을 마스터합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'Kotlin을 활용한 현대적인 안드로이드 앱 개발을 학습합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'Apache Kafka를 활용한 대용량 실시간 데이터 스트리밍을 학습합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'Shopify 플랫폼을 활용한 전문적인 이커머스 사이트 개발을 학습합니다.',
      description:
    ...
    },
    {
      ...
      shortDescription: 'Terraform을 활용한 인프라스트럭처 as Code 구현을 마스터합니다.',
      description:
